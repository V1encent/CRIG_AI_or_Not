...
(function (g) {
  ...
  var DICT = {
    nl: {
      ...
      'deck.sub': '12 puzzels verdeeld over 6 niveaus',
      ...
      'teach.noteBadge': '💡 AI Herkenningstip',
      'teach.noteTitle': 'Hoe herken je de AI?',
      'teach.showNote': '💡 Toon uitleg',
      'difficulty.rising': 'Moeilijkheid stijgt',
      'difficulty.level': 'Niveau',
      'difficulty.l1': 'Makkelijk',
      'difficulty.l2': 'Toegankelijk',
      'difficulty.l3': 'Gemiddeld',
      'difficulty.l4': 'Uitdagend',
      'difficulty.l5': 'Moeilijk',
      'difficulty.l6': 'Expert',
    ...
    en: {
      ...
      'deck.title': 'Deck Manager (PPTX)',
      'deck.sub': '12 puzzles across 6 levels',
      ...
      'teach.noteBadge': '💡 AI Detection Tip',
      'teach.noteTitle': 'How to spot the AI?',
      'teach.showNote': '💡 Show explanation',
      'difficulty.rising': 'Difficulty increases',
      'difficulty.level': 'Level',
      'difficulty.l1': 'Easy',
      'difficulty.l2': 'Accessible',
      'difficulty.l3': 'Medium',
      'difficulty.l4': 'Challenging',
      'difficulty.l5': 'Hard',
      'difficulty.l6': 'Expert',
