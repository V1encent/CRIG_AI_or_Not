...
(function (g) {
  ...
  g.AON_CONFIG = {
    ...
    progressive: {
      enabled: true,
      pairsPerLevel: 2,           // 每级抽 2 题，全部 12 道题目按难度递增展示
      targetTotalScore: 12,       // 总积分 12 分（每题平均分配 1 分）
      pointsPerQuestion: 1,       // 每道题答对得 1 分
      maxLevel: 6,
      autoAdvance: false          // 禁止自动翻页：允许观众充分阅读 AI 破绽解析与提示
    },
